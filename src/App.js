...
function App() {
  ...
  return (
    <div className="w-screen h-screen bg-green-800 flex justify-center items-center">
      ...
      <div className=" w-[60%] h-[70%] bg-white rounded-2xl relative flex flex-col justify-center gap-14 items-center ">
        <div className="w-full h-full flex flex-col justify-center gap-14 items-center absolute left-2/4 top-2/4 -translate-x-2/4 -translate-y-2/4">
